...
## Environments
- Preview: https://main--itc-aashirvaad-maji--aemysites.aem.page/
- Live: https://main--itc-aashirvaad-maji--aemysites.aem.live/
- Block Library: https://main--itc-aashirvaad-maji--aemysites.aem.page/tools/sidekick/library.html?plugin=blocks
...
1. Open the `itc-aashirvaad-maji` directory in your favorite IDE and start coding :)
